...
//        _librery.flag = [self isiPhone_X:_librery.iDevice];
    });
    return _librery;
}
...
- (BOOL)isiPhone_X{
    return [iDeviceiPhone_X[self.iDevice]  isEqualToString:@"1"] ? YES : NO;
}
...
#pragma mark - 是否是 iPhone X  自动匹配iPhone 硬件版本
- (BOOL)autoMachineToIdevice{
...
#pragma Containers
static const NSString *iDeviceiPhone_X[] = {
    [iPhone_1G]                 = @"0",
    [iPhone_3G]                 = @"0",
    [iPhone_3GS]                = @"0",
    [iPhone_4]                  = @"0",
    ...
    [iPhone_5_CDMA]             = @"0",
    [iPhone_5C_GSM]             = @"0",
    [iPhone_5C_GSM_CDMA]        = @"0",
    [iPhone_5S_GSM]             = @"0",
    [iPhone_5S_GSM_CDMA]        = @"0",
    [iPhone_6]                  = @"0",
    [iPhone_6_Plus]             = @"0",
    [iPhone_6S]                 = @"0",
    [iPhone_6S_Plus]            = @"0",
    [iPhone_SE]                 = @"0",
    [Chinese_iPhone_7]          = @"0",
    [Chinese_iPhone_7_Plus]     = @"0",
    [American_iPhone_7]         = @"0",
    [American_iPhone_7_Plus]    = @"0",
    [Chinese_iPhone_8]          = @"0",
    [Chinese_iPhone_8_Plus]     = @"0",
    [Chinese_iPhone_X]          = @"1",
    [Global_iPhone_8]           = @"0",
    [Global_iPhone_8_Plus]      = @"0",
    [Global_iPhone_X]           = @"1",
    ...
    [iPad_Air_Cellular]         = @"0",
    [iPad_Air_2_WiFi]           = @"0",
    [iPad_Air_2_Cellular]       = @"0",
    [iPad_Mini_WiFi]            = @"0",
    [iPad_Mini_GSM]             = @"0",
    [iPad_Mini_CDMA]            = @"0",
    [iPad_Mini_2]               = @"0",
    [iPad_Mini_2_Cellular]      = @"0",
    [iPad_Mini_3_WiFi]          = @"0",
    [iPad_Mini_3_Cellular]      = @"0",
    [iPad_Mini_4_WiFi]          = @"0",
    [iPad_Mini_4_Cellular]      = @"0",
    
    [iPad_Pro_97inch_WiFi]      = @"0",
    [iPad_Pro_97inch_Cellular]  = @"0",
    [iPad_Pro_129inch_WiFi]     = @"0",
    [iPad_Pro_129inch_Cellular] = @"0",
    [iPad_5_WiFi]               = @"0",
    [iPad_5_Cellular]           = @"0",
    [iPad_Pro_129inch_2nd_gen_WiFi]     = @"0",
    [iPad_Pro_129inch_2nd_gen_Cellular] = @"0",
    [iPad_Pro_105inch_WiFi]             = @"0",
    [iPad_Pro_105inch_Cellular]         = @"0",
