...
@interface PlaneController ()<UITableViewDelegate,UITableViewDataSource,TXScrollLabelViewDelegate>
...
//    ////    autoLabel.labelBetweenGap = 10;
   ...
   _scrollLabelView.scrollLabelViewDelegate = self;
    ...
    UIView *rankView = [[UIView alloc] initWithFrame:CGRectMake(0, 500-40*scale_h, kWidth, 40*scale_h)];
    rankView.backgroundColor = [UIColor whiteColor];
    [_headView addSubview:rankView];
    ...
    UIView *rankView2 = [[UIView alloc] initWithFrame:CGRectMake(-1, 500, kWidth+2, 40*scale_h)];
    ...
    [_headView addSubview:rankView2];
...
- (UITableView *)tableview{
    if (!_tableview) {
        _tableview = [[UITableView alloc] initWithFrame:CGRectMake(0, kStatusBarHeight, kWidth, kHeight-kTabBar-kStatusBarHeight) style:UITableViewStylePlain];
