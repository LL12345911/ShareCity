...
- (void)viewDidLoad {
    ...
    [self.view insertSubview:self.customNavBar aboveSubview:_scanRectView];
    
    [self.customNavBar wr_setRightButtonWithTitle:@"相册" titleColor:[UIColor whiteColor]];
