...
@implementation CoinTypeViewCell
...
- (void)setValueByCoinTypeModel:(CoinTypeModel *)model{
    ...
    ////1：用户选中  0：用户未选
    if ([model.ischecked intValue] == 1) {
        _coinImage2.image = [UIImage imageNamed:@"对号"];
    }else{
        _coinImage2.image = [UIImage new];
    }
