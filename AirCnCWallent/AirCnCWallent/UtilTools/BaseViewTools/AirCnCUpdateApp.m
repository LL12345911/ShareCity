...
@implementation AirCnCUpdateApp
...
+(void)hs_updateWithAPPID:(NSString *)appId withBundleId:(NSString *)bundelId block:(UpdateBlock)block{
    ...
    NSURLSessionDataTask *task = [session dataTaskWithRequest:request completionHandler:^(NSData * _Nullable data, NSURLResponse * _Nullable response, NSError * _Nullable error) {
        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            ...
            NSLog(@"【3】苹果服务器返回的检测结果：\n appId = %@ \n bundleId = %@ \n 开发账号名字 = %@ \n 商店版本号 = %@ \n 应用名称 = %@ \n 打开连接 = %@  \n更新内容 = %@",appInfoDic[@"results"][0][@"artistId"],appInfoDic[@"results"][0][@"bundleId"],appInfoDic[@"results"][0][@"artistName"],appInfoDic[@"results"][0][@"version"],appInfoDic[@"results"][0][@"trackName"],appInfoDic[@"results"][0][@"trackViewUrl"],appInfoDic[@"results"][0][@"releaseNotes"]);
            ...
            if([currentVersion floatValue] < [appStoreVersion floatValue])
            {
                ...
                //block(currentVersion,appInfoDic[@"results"][0][@"version"],[NSString stringWithFormat:@"https://itunes.apple.com/us/app/id%@?ls=1&mt=8", appId],YES);
                block(infoDic[@"CFBundleShortVersionString"],appInfoDic[@"results"][0][@"version"],[NSString stringWithFormat:@"https://itunes.apple.com/us/app/id%@?ls=1&mt=8", appId],appInfoDic[@"results"][0][@"releaseNotes"],YES);
            }else{
                // NSLog(@"【4】判断结果：当前版本号%@ > 商店版本号%@ 不需要更新\n========我是分割线========",[[NSBundle mainBundle] infoDictionary][@"CFBundleShortVersionString"],appInfoDic[@"results"][0][@"version"]);
                // block(currentVersion,appInfoDic[@"results"][0][@"version"],[NSString stringWithFormat:@"https://itunes.apple.com/us/app/id%@?ls=1&mt=8", appId],NO);//infoDic[@"CFBundleShortVersionString"]
                
                block(appInfoDic[@"results"][0][@"version"],appInfoDic[@"results"][0][@"version"],[NSString stringWithFormat:@"https://itunes.apple.com/us/app/id%@?ls=1&mt=8", appId],appInfoDic[@"results"][0][@"releaseNotes"],NO);
            }
        });
    }];
    [task resume];
